...
const todoCollection = document.getElementById("todo_collection");
...
let index = 0;
// todo ni aadar aavata valure ne handel kravau kary kare 6e
...
const displaytodo = () => {   // Display todo
    todoCollection.innerHTML = "";
    value_list.map((todo, i) => {    // vlue.list ke aadar ((todo)=)
